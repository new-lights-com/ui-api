...
<!--
  SpotBugs - Spot bugs in Java programs
...
<!--
  ...
  human-readable messages in the XML.  Invoke the spotbugs script
  as follows:

    spotbugs -textui -xml:withMessages -project myProject.fb > results.xml
...
<xsl:stylesheet
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <h2>Metrics</h2>
                <xsl:apply-templates select="/BugCollection/SpotBugsSummary"/>
    ...
    <xsl:template match="SpotBugsSummary">
