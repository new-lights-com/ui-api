...
import music from "../assets/music/Demons - Imagine Dragons.mp3";
                                ...
                                <div className="h-full">
                                    <div
                                        ...
                                        <div className="ext-stone-400 px-8 py-20 pb-52 h-full ">
                                            {/*  */}
                                            <div
                                                className=" max-w-screen-xl mt-8 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-stone-200 text-neutral-900 rounded-lg shadow-xl">
                                                <div className="flex flex-col justify-between ">
                                                    <div>
                                                        <h2 className="text-4xl lg:text-5xl font-bold leading-tight">About our Team!!</h2>
                                                        <div className="text-neutral-700 mt-8">
                                                            Send us an <span className="underline cursor-pointer">message</span>.
                                                        </div>
                                                    </div>
                                                        ...
                                                        <svg className="w-full" xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <defs>
                                                                <linearGradient id="eb6c86d6-45fa-49e0-9a60-1b0612516196" x1="819.07" y1="732.58" x2="819.07"
                                                                    ...
                                                                    <stop offset="0" stop-color="neutral" stop-opacity="0.25" />
                                                                    <stop offset="0.54" stop-color="neutral" stop-opacity="0.12" />
                                                                    <stop offset="1" stop-color="neutral" stop-opacity="0.1" />
                                                                </linearGradient>
                                                            ...
                                                            <g opacity="0.1">
                                                                <ellipse cx="479.42" cy="362.12" rx="11.38" ry="14.9" fill="#563f3d" />
                                                                <path
                                                                    ...
                                                                    transform="translate(-52 -162.63)" fill="#563f3d" />
                                                                <ellipse cx="479.42" cy="271.07" rx="11.38" ry="14.9" fill="#563f3d" />
                                                                <ellipse cx="479.42" cy="252.86" rx="11.38" ry="14.9" fill="#563f3d" />
                                                                <path
                                                                    ...
                                                                    transform="translate(-52 -162.63)" fill="#ea9066" />
                                                                <path
                                                            ...
                                                            <g opacity="0.1">
                                                                <ellipse cx="612.28" cy="330.26" rx="8.51" ry="11.13" fill="#563f3d" />
                                                                <path
                                                                    ...
                                                                    transform="translate(-52 -162.63)" fill="#563f3d" />
                                                                <ellipse cx="612.28" cy="262.22" rx="8.51" ry="11.13" fill="#563f3d" />
                                                                <ellipse cx="612.28" cy="248.61" rx="8.51" ry="11.13" fill="#563f3d" />
                                                                <path
                                                            ...
                                                            <g opacity="0.1">
                                                                <ellipse cx="1038.58" cy="322.12" rx="11.38" ry="14.9" fill="#563f3d" />
                                                                <path
                                                                    ...
                                                                    transform="translate(-52 -162.63)" fill="#563f3d" />
                                                                <ellipse cx="1038.58" cy="231.07" rx="11.38" ry="14.9" fill="#563f3d" />
                                                                <ellipse cx="1038.58" cy="212.86" rx="11.38" ry="14.9" fill="#563f3d" />
                                                                <path
                                                            ...
                                                            <g opacity="0.1">
                                                                <ellipse cx="928.72" cy="324.26" rx="8.51" ry="11.13" fill="#563f3d" />
                                                                <path
                                                                    ...
                                                                    transform="translate(-52 -162.63)" fill="#563f3d" />
                                                                <ellipse cx="928.72" cy="256.22" rx="8.51" ry="11.13" fill="#563f3d" />
                                                                <ellipse cx="928.72" cy="242.61" rx="8.51" ry="11.13" fill="#563f3d" />
                                                                <path
                                                            ...
                                                            <g opacity="0.1">
                                                                <ellipse cx="61.59" cy="322.12" rx="11.38" ry="14.9" fill="#563f3d" />
                                                                <path
                                                                    ...
                                                                    transform="translate(-52 -162.63)" fill="#563f3d" />
                                                                <ellipse cx="61.59" cy="231.07" rx="11.38" ry="14.9" fill="#563f3d" />
                                                                <ellipse cx="61.59" cy="212.86" rx="11.38" ry="14.9" fill="#563f3d" />
                                                                <path
                                                            ...
                                                            <g opacity="0.1">
                                                                <ellipse cx="171.44" cy="324.26" rx="8.51" ry="11.13" fill="#563f3d" />
                                                                <path
                                                                    ...
                                                                    transform="translate(-52 -162.63)" fill="#563f3d" />
                                                                <ellipse cx="171.44" cy="256.22" rx="8.51" ry="11.13" fill="#563f3d" />
                                                                <ellipse cx="171.44" cy="242.61" rx="8.51" ry="11.13" fill="#563f3d" />
                                                                <path
                                                            ...
                                                            <ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="#ea9066" opacity="0.1" />
                                                            <ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="#ea9066" opacity="0.1" />
                                                            <ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="#ea9066" opacity="0.1" />
                                                            <ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="#ea9066" opacity="0.1" />
                                                            <path
                                                                ...
                                                                transform="translate(-52 -162.63)" fill="#ea9066" opacity="0.1" />
                                                            <path
                                                            ...
                                                            <path
                                                                ...
                                                                transform="translate(-52 -162.63)" fill="none" stroke="#563f3d" stroke-miterlimit="10"
                                                                stroke-width="4" />
                                                            ...
                                                            <path
                                                                ...
                                                                transform="translate(-52 -162.63)" opacity="0.1" />
                                                            <circle cx="779.73" cy="238.18" r="99.96" fill="#563f3d" />
                                                            <path
                                                            ...
                                                            <path
                                                                ...
                                                                transform="translate(-52 -162.63)" opacity="0.1" />
                                                            <circle cx="550.08" cy="390.01" r="99.96" fill="#563f3d" />
                                                            <path
                                                            ...
                                                            <path
                                                                ...
                                                                transform="translate(-52 -162.63)" opacity="0.1" />
                                                            <circle cx="312.85" cy="315.36" r="99.96" fill="#563f3d" />
                                                            ...
                                                            <path
                                                                ...
                                                                transform="translate(-52 -162.63)" fill="#fbfbbe" />
                                                            <path
                                                ...
                                                <div className="">
                                                    <div>
                                                        <a className="uppercase text-lg text-neutral-600 font-bold no-underline hover:text-orange-500 hover:text-xl" href='/' >NEW LIGHTS</a>
                                                        <p>What is Lorem Ipsum?
                                                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                                                    </div>
                                                    <div className="mt-4">
                                                        <span className="uppercase text-sm text-neutral-600 font-bold flex">Email - <code className='px-2 text-neutral-400'>adamantiumforce9@gmail.com</code></span>
                                                    </div>
                                                    <div className="mt-2">
                            <span className="uppercase text-sm text-neutral-600 font-bold">Team Members -
                                <div className='p-2'>
                                    <code className='px-2 text-neutral-100 bg-neutral-400 mx-1'>Rajan</code>
                                    <code className='px-2 text-neutral-100 bg-neutral-400 mx-1'>Ghazal</code>
                                </div>
                            </span>
                                                    </div>
                                                </div>
